...
import com.example.footballapp.databinding.DialogTryAgainBinding
import com.example.footballapp.models.matchmodels.BlurUtils

class TryAgainDialog(context: Context) : Dialog(context) {

    private lateinit var binding: DialogTryAgainBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DialogTryAgainBinding.inflate(layoutInflater)
